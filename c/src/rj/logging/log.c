...
void rj_log_error(const char *const format, ...)
{
    va_list args;
...
void rj_log_warn(const char *const format, ...)
{
    va_list args;
...
void rj_log_info(const char *const format, ...)
{
    va_list args;
...
void rj_log_debug(const char *const format, ...)
{
    va_list args;
...
void rj_log_trace(const char *const format, ...)
{
    va_list args;
...
void rj_log_set_error(RJError **error, const char *const format, ...)
{
    va_list args;
...
void rj_log_set_errno(RJError **error, int errnum)
{
    ...
    rj_log_error("%d: %s", errnum, strerror(errnum));
}
